...
type Input = Evaluate<"1+1+1+1+1+1+1+1+100", GeneratorState<readonly ["00000001", "00000002", "00000003", "00000004"]>, 1>;
...
export type ast_arithmetic_tie = Assert<Equal<Input, Expected>>;
