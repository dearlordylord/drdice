...
type Expected = Success<{ readonly total: 1; readonly rollTrace: readonly [DieSample<6, 1>]; readonly nextState: GeneratorState<readonly ["00000007", "00000000", "00000402", "00003000"]> }>;
export type uppercase_die = Assert<Equal<Input, Expected>>;
