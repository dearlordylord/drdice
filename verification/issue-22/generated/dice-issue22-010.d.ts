...
type Expected = Success<{ readonly total: 8; readonly rollTrace: [DieSample<1, 1>, DieSample<1, 1>, DieSample<1, 1>, DieSample<1, 1>, DieSample<1, 1>, DieSample<1, 1>, DieSample<1, 1>, DieSample<1, 1>]; readonly nextState: GeneratorState<readonly ["3320a290", "ebdc5e1d", "90c43618", "e4b42f08"]> }>;
