...
type Expected = Success<{ readonly total: 11; readonly rollTrace: [DieSample<1, 1>, DieSample<1, 1>, DieSample<1, 1>, DieSample<1, 1>, DieSample<1, 1>, DieSample<1, 1>, DieSample<1, 1>, DieSample<1, 1>]; readonly successorState: GeneratorState<readonly ["3320a290", "ebdc5e1d", "90c43618", "e4b42f08"]> }>;
