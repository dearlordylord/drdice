...
type Expected = Success<{ readonly total: 7; readonly rollTrace: [DieSample<6, 1>, DieSample<6, 6>]; readonly nextState: GeneratorState<readonly ["ffffffff", "00000000", "000001ff", "ffffffff"]> }>;
